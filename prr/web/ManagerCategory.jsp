...
<html lang="en">
    ...
    <body>
        ...
        <c:if test="${sessionScope.acc.isAdmin!=1}">
            <form  style="padding-left: 800px ; padding-top: 450px"
                   action="home" method="get">
                <table border="1">
                    <tr>
                        <td><h1 style="color: red">Please Login to use this option!!</h1>
                            <h1 style="text-align: center;color: blue"><input type="submit" value="Go Home"></h1> 
                        </td> 
                    </tr>
                </table>
