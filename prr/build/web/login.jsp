    ...
    <body>
        <div id="logreg-forms">
            <form class="form-signin" action="login">
                ...
                <input type="text" id="inputEmail" class="form-control" placeholder="Username" required="" autofocus="" name="Username" value="${cookie.cuser.value}">
                <input type="password" id="inputPassword" class="form-control" placeholder="Password" required="" name="Password" value="${cookie.cpass.value}">
                <label class="checkbox-wrap checkbox-primary mb-0" style="padding-left: 136px ">Remember Me
                     <input type="checkbox" id="inputPassword" class="form-control" name="remem" >
                                                </label>
